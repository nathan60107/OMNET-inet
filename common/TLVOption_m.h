...
/**
 * Class generated from <tt>inet/common/TLVOption.msg:28</tt> by nedtool.
 * <pre>
 * class TLVOptionBase
 * {
 *     short type = -1;
...
/**
 * Class generated from <tt>inet/common/TLVOption.msg:34</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/common/TLVOption.msg:39</tt> by nedtool.
 * <pre>
 * class TLVOptions
 * {
 *     @customize(true);
...
class TLVOptions_Base : public ::omnetpp::cObject
{
  ...
  public:
    ...
    virtual TLVOptions_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class TLVOptions");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
