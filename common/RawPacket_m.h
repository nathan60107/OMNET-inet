...
class RawPacket_Base : public ::omnetpp::cPacket
{
  ...
  protected:
    ...
    RawPacket_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RawPacket_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RawPacket");}
