...
ByteArray_Base::ByteArray_Base() : ::omnetpp::cObject()
{
    data_arraysize = 0;
    this->data_var = 0;
}

ByteArray_Base::ByteArray_Base(const ByteArray_Base& other) : ::omnetpp::cObject(other)
{
    data_arraysize = 0;
    this->data_var = 0;
    copy(other);
...
ByteArray_Base::~ByteArray_Base()
{
    delete [] this->data_var;
}

ByteArray_Base& ByteArray_Base::operator=(const ByteArray_Base& other)
{
...
void ByteArray_Base::copy(const ByteArray_Base& other)
{
    delete [] this->data_var;
    this->data_var = (other.data_arraysize==0) ? nullptr : new char[other.data_arraysize];
    data_arraysize = other.data_arraysize;
    for (unsigned int i=0; i<data_arraysize; i++)
        this->data_var[i] = other.data_var[i];
}

void ByteArray_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    b->pack(data_arraysize);
    doParsimArrayPacking(b,this->data_var,data_arraysize);
}

void ByteArray_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    delete [] this->data_var;
    ...
    if (data_arraysize==0) {
        ...
        doParsimArrayUnpacking(b,this->data_var,data_arraysize);
    }
}

void ByteArray_Base::setDataArraySize(unsigned int size)
{
    char *data_var2 = (size==0) ? nullptr : new char[size];
...
unsigned int ByteArray_Base::getDataArraySize() const
{
    return data_arraysize;
}

char ByteArray_Base::getData(unsigned int k) const
{
    if (k>=data_arraysize) throw omnetpp::cRuntimeError("Array of size %d indexed by %d", data_arraysize, k);
    return this->data_var[k];
}

void ByteArray_Base::setData(unsigned int k, char data)
{
    if (k>=data_arraysize) throw omnetpp::cRuntimeError("Array of size %d indexed by %d", data_arraysize, k);
...
ByteArrayDescriptor::ByteArrayDescriptor() : omnetpp::cClassDescriptor("inet::ByteArray", "omnetpp::cObject")
{
...
{
    return dynamic_cast<ByteArray_Base *>(obj)!=nullptr;
}
...
int ByteArrayDescriptor::getFieldArraySize(void *object, int field) const
{
    ...
    ByteArray_Base *pp = (ByteArray_Base *)object; (void)pp;
    switch (field) {
