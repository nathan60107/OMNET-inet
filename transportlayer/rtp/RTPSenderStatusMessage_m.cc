//
// Generated file, do not edit! Created by nedtool 5.0 from inet/transportlayer/rtp/RTPSenderStatusMessage.msg.
//
...
EXECUTE_ON_STARTUP(
    omnetpp::cEnum *e = omnetpp::cEnum::find("inet::rtp::RTPSenderStatus");
    if (!e) omnetpp::enums.getInstance()->add(e = new omnetpp::cEnum("inet::rtp::RTPSenderStatus"));
...
RTPSenderStatusMessage::RTPSenderStatusMessage(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->status = 0;
    this->timeStamp = 0;
}
...
RTPSenderStatusMessageDescriptor::RTPSenderStatusMessageDescriptor() : omnetpp::cClassDescriptor("inet::rtp::RTPSenderStatusMessage", "omnetpp::cPacket")
{
...
int RTPSenderStatusMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string RTPSenderStatusMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool RTPSenderStatusMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *RTPSenderStatusMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
