//
// Generated file, do not edit! Created by nedtool 5.0 from inet/transportlayer/rtp/RTCPPacket3.msg.
//
...
RTCPSenderReportPacket_Base::RTCPSenderReportPacket_Base(const char *name, int kind) : ::inet::rtp::RTCPReceiverReportPacket(name,kind)
{
    this->setPacketType(RTCP_PT_SR);

}

RTCPSenderReportPacket_Base::RTCPSenderReportPacket_Base(const RTCPSenderReportPacket_Base& other) : ::inet::rtp::RTCPReceiverReportPacket(other)
{
    copy(other);
}
...
RTCPSenderReportPacket_Base& RTCPSenderReportPacket_Base::operator=(const RTCPSenderReportPacket_Base& other)
{
...
void RTCPSenderReportPacket_Base::copy(const RTCPSenderReportPacket_Base& other)
{
    this->senderReport = other.senderReport;
}

void RTCPSenderReportPacket_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::inet::rtp::RTCPReceiverReportPacket::parsimPack(b);
    doParsimPacking(b,this->senderReport);
}

void RTCPSenderReportPacket_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::rtp::RTCPReceiverReportPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->senderReport);
}

SenderReport& RTCPSenderReportPacket_Base::getSenderReport()
{
    return this->senderReport;
}

void RTCPSenderReportPacket_Base::setSenderReport(const SenderReport& senderReport)
{
...
RTCPSenderReportPacketDescriptor::RTCPSenderReportPacketDescriptor() : omnetpp::cClassDescriptor("inet::rtp::RTCPSenderReportPacket", "inet::rtp::RTCPReceiverReportPacket")
{
...
{
    return dynamic_cast<RTCPSenderReportPacket_Base *>(obj)!=nullptr;
}
...
int RTCPSenderReportPacketDescriptor::getFieldArraySize(void *object, int field) const
{
    ...
    RTCPSenderReportPacket_Base *pp = (RTCPSenderReportPacket_Base *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}
...
std::string RTCPSenderReportPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    RTCPSenderReportPacket_Base *pp = (RTCPSenderReportPacket_Base *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getSenderReport(); return out.str();}
        default: return "";
    }
}
...
const char *RTCPSenderReportPacketDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 0: return omnetpp::opp_typename(typeid(SenderReport));
        default: return nullptr;
    };
}
...
void *RTCPSenderReportPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    RTCPSenderReportPacket_Base *pp = (RTCPSenderReportPacket_Base *)object; (void)pp;
    switch (field) {
        case 0: return (void *)(&pp->getSenderReport()); break;
        default: return nullptr;
    }
}
