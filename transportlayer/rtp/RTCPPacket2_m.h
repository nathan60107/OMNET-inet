...
#ifndef __INET__RTP_RTCPPACKET2_M_H
#define __INET__RTP_RTCPPACKET2_M_H
 ...
 *   public:
 *     RTCPReceiverReportPacket(const char *name=nullptr, int kind=0) : RTCPReceiverReportPacket_Base(name,kind) {}
 ...
 * </pre>
 */
class RTCPReceiverReportPacket_Base : public ::inet::rtp::RTCPPacket
{
  protected:
    uint32_t ssrc_var;
  ...
  protected:
    ...
    RTCPReceiverReportPacket_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RTCPReceiverReportPacket_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RTCPReceiverReportPacket");}
 ...
 *   public:
 *     RTCPSDESPacket(const char *name=nullptr, int kind=0) : RTCPSDESPacket_Base(name,kind) {}
 ...
 * </pre>
 */
class RTCPSDESPacket_Base : public ::inet::rtp::RTCPPacket
{
  protected:
  ...
  protected:
    ...
    // make constructors protected to avoid instantiation
    RTCPSDESPacket_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RTCPSDESPacket_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RTCPSDESPacket");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
 ...
 *   public:
 *     RTCPByePacket(const char *name=nullptr, int kind=0) : RTCPByePacket_Base(name,kind) {}
 ...
 * </pre>
 */
class RTCPByePacket_Base : public ::inet::rtp::RTCPPacket
{
  protected:
    uint32_t ssrc;
  ...
  protected:
    ...
    // make constructors protected to avoid instantiation
    RTCPByePacket_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RTCPByePacket_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RTCPByePacket");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
...
#endif // ifndef __INET__RTP_RTCPPACKET2_M_H
