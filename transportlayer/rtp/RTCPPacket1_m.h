...
class RTCPPacket_Base : public ::omnetpp::cPacket
{
  ...
  protected:
    ...
    RTCPPacket_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RTCPPacket_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RTCPPacket");}
...
class RTCPCompoundPacket_Base : public ::omnetpp::cPacket
{
  ...
  protected:
    ...
    // make constructors protected to avoid instantiation
    RTCPCompoundPacket_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RTCPCompoundPacket_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RTCPCompoundPacket");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
