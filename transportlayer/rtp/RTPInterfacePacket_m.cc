//
// Generated file, do not edit! Created by nedtool 5.0 from inet/transportlayer/rtp/RTPInterfacePacket.msg.
//
...
RTPControlMsg::RTPControlMsg(const char *name, int kind) : ::omnetpp::cMessage(name,kind)
{
}
