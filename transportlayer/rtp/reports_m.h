...
/**
 * Class generated from <tt>inet/transportlayer/rtp/reports.msg:17</tt> by nedtool.
 * <pre>
 * //
...
class SenderReport_Base : public ::omnetpp::cObject
{
  ...
  public:
    ...
    virtual SenderReport_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class SenderReport");}
...
/**
 * Class generated from <tt>inet/transportlayer/rtp/reports.msg:38</tt> by nedtool.
 * <pre>
 * //
...
class ReceptionReport_Base : public ::omnetpp::cObject
{
  ...
  public:
    ...
    virtual ReceptionReport_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class ReceptionReport");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
