//
// Generated file, do not edit! Created by nedtool 5.0 from inet/transportlayer/rtp/RTCPPacket2.msg.
//
...
RTCPReceiverReportPacket_Base::RTCPReceiverReportPacket_Base(const char *name, int kind) : ::inet::rtp::RTCPPacket(name,kind)
{
...
void RTCPReceiverReportPacket_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->receptionReports_var);
}
...
void RTCPReceiverReportPacket_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->receptionReports_var);
}
...
{
    return this->receptionReports_var;
}
...
RTCPSDESPacket_Base::RTCPSDESPacket_Base(const char *name, int kind) : ::inet::rtp::RTCPPacket(name,kind)
{
...
{
    ::inet::rtp::RTCPPacket::parsimPack(b);
    doParsimPacking(b,this->sdesChunks_var);
}

void RTCPSDESPacket_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::rtp::RTCPPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->sdesChunks_var);
}

cArray& RTCPSDESPacket_Base::getSdesChunks()
{
    return this->sdesChunks_var;
}
...
RTCPByePacket_Base::RTCPByePacket_Base(const char *name, int kind) : ::inet::rtp::RTCPPacket(name,kind)
{
