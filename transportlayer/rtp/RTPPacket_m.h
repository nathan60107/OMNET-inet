...
/**
 * Enum generated from <tt>inet/transportlayer/rtp/RTPPacket.msg:27</tt> by nedtool.
 * <pre>
 * enum RTPPacketEnums
 * {
 * 
...
/**
 * Class generated from <tt>inet/transportlayer/rtp/RTPPacket.msg:40</tt> by nedtool.
 * <pre>
 * //
...
class RTPPacket_Base : public ::omnetpp::cPacket
{
  protected:
    ...
    bool extension_var;
    bool marker_var;
    int8_t payloadType_var;
    uint16_t sequenceNumber_var;
    uint32_t timeStamp_var;
    uint32_t ssrc_var;
    uint32_t *csrc_var; // array ptr
  ...
  protected:
    ...
    RTPPacket_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RTPPacket_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RTPPacket");}
