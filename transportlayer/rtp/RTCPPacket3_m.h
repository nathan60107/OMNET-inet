 ...
 *   public:
 *     RTCPSenderReportPacket(const char *name=nullptr, int kind=0) : RTCPSenderReportPacket_Base(name,kind) {}
...
class RTCPSenderReportPacket_Base : public ::inet::rtp::RTCPReceiverReportPacket
{
  ...
  protected:
    ...
    RTCPSenderReportPacket_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RTCPSenderReportPacket_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RTCPSenderReportPacket");}
