...
class RTPInnerPacket_Base : public ::omnetpp::cPacket
{
  protected:
    short type_var;
    ::omnetpp::opp_string commonName_var;
    int mtu_var;
    int bandwidth_var;
    ...
    uint32_t ssrc_var;
    int payloadType_var;
    ::omnetpp::opp_string fileName_var;
    int clockRate_var;
  ...
  protected:
    ...
    RTPInnerPacket_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RTPInnerPacket_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RTPInnerPacket");}
