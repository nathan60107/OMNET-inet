//
// Generated file, do not edit! Created by nedtool 5.0 from inet/transportlayer/rtp/RTCPPacket1.msg.
//
...
RTCPPacket_Base::RTCPPacket_Base(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
...
void RTCPPacket_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->count_var);
    doParsimPacking(b,this->packetType_var);
...
void RTCPPacket_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->count_var);
    doParsimUnpacking(b,this->packetType_var);
...
RTCPCompoundPacket_Base::RTCPCompoundPacket_Base(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
