 ...
 *   public:
 *     UDPPacket(const char *name=nullptr, int kind=0) : UDPPacket_Base(name,kind) {}
...
class UDPPacket_Base : public ::omnetpp::cPacket
{
  ...
  protected:
    ...
    UDPPacket_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual UDPPacket_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class UDPPacket");}
