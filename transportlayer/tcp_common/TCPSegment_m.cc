//
// Generated file, do not edit! Created by nedtool 5.0 from inet/transportlayer/tcp_common/TCPSegment.msg.
//
...
TCPSegment_Base::TCPSegment_Base(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->srcPort_var = 0;
    this->destPort_var = 0;
