//
// Generated file, do not edit! Created by nedtool 5.0 from inet/transportlayer/sctp/SCTPMessage.msg.
//
...
SCTPMessage_Base::SCTPMessage_Base(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->srcPort = 0;
    this->destPort = 0;
    this->tag = 0;
...
SCTPChunk::SCTPChunk(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->chunkType = 0;
    this->flags = 0;
}
...
SCTPInitChunk::SCTPInitChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->initTag = 0;
    this->a_rwnd = 0;
    this->noOutStreams = 0;
...
SCTPInitAckChunk::SCTPInitAckChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->initTag = 0;
    this->a_rwnd = 0;
    this->noOutStreams = 0;
...
SCTPCookieEchoChunk::SCTPCookieEchoChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    cookie_arraysize = 0;
    this->cookie = 0;
    this->stateCookie = nullptr;
...
SCTPCookie::SCTPCookie(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->creationTime = 0;
    this->localTag = 0;
    this->peerTag = 0;
...
SCTPCookieAckChunk::SCTPCookieAckChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
}
...
SCTPDataMsg::SCTPDataMsg(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->eBit = 0;
    this->bBit = 0;
...
SCTPDataChunk::SCTPDataChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->eBit = 0;
    this->bBit = 0;
    this->uBit = 0;
...
SCTPForwardTsnChunk::SCTPForwardTsnChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->newCumTsn = 0;
    sid_arraysize = 0;
    this->sid = 0;
...
SCTPSackChunk::SCTPSackChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->cumTsnAck = 0;
    this->a_rwnd = 0;
    this->numGaps = 0;
...
SCTPAbortChunk::SCTPAbortChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->T_Bit = 0;
}
...
SCTPHeartbeatChunk::SCTPHeartbeatChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->timeField = 0;
    info_arraysize = 0;
    this->info = 0;
...
SCTPHeartbeatAckChunk::SCTPHeartbeatAckChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->timeField = 0;
    info_arraysize = 0;
    this->info = 0;
...
SCTPShutdownChunk::SCTPShutdownChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->cumTsnAck = 0;
}
...
SCTPShutdownAckChunk::SCTPShutdownAckChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
}
...
SCTPShutdownCompleteChunk::SCTPShutdownCompleteChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->TBit = 0;
}
...
SCTPErrorChunk_Base::SCTPErrorChunk_Base(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->TBit = 0;
    this->MBit = 0;
}
...
SCTPParameter::SCTPParameter(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
...
SCTPPacketDropChunk::SCTPPacketDropChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->cFlag = false;
    this->tFlag = false;
    this->bFlag = false;
...
SCTPStreamResetChunk_Base::SCTPStreamResetChunk_Base(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
}
...
SCTPOutgoingSSNResetRequestParameter::SCTPOutgoingSSNResetRequestParameter(const char *name, int kind) : ::inet::sctp::SCTPParameter(name,kind)
{
    this->srReqSn = 0;
    this->srResSn = 0;
    this->lastTsn = 0;
...
SCTPIncomingSSNResetRequestParameter::SCTPIncomingSSNResetRequestParameter(const char *name, int kind) : ::inet::sctp::SCTPParameter(name,kind)
{
    this->srReqSn = 0;
    streamNumbers_arraysize = 0;
    this->streamNumbers = 0;
...
SCTPIncomingSSNResetRequestParameter::SCTPIncomingSSNResetRequestParameter(const SCTPIncomingSSNResetRequestParameter& other) : ::inet::sctp::SCTPParameter(other)
{
    streamNumbers_arraysize = 0;
    this->streamNumbers = 0;
    copy(other);
...
void SCTPIncomingSSNResetRequestParameter::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::inet::sctp::SCTPParameter::parsimPack(b);
    doParsimPacking(b,this->srReqSn);
    b->pack(streamNumbers_arraysize);
...
void SCTPIncomingSSNResetRequestParameter::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::sctp::SCTPParameter::parsimUnpack(b);
    doParsimUnpacking(b,this->srReqSn);
    delete [] this->streamNumbers;
...
uint32_t SCTPIncomingSSNResetRequestParameter::getSrReqSn() const
{
    return this->srReqSn;
}

void SCTPIncomingSSNResetRequestParameter::setSrReqSn(uint32_t srReqSn)
{
    this->srReqSn = srReqSn;
}
...
uint16_t SCTPIncomingSSNResetRequestParameter::getStreamNumbers(unsigned int k) const
{
    if (k>=streamNumbers_arraysize) throw omnetpp::cRuntimeError("Array of size %d indexed by %d", streamNumbers_arraysize, k);
    return this->streamNumbers[k];
}

void SCTPIncomingSSNResetRequestParameter::setStreamNumbers(unsigned int k, uint16_t streamNumbers)
{
    if (k>=streamNumbers_arraysize) throw omnetpp::cRuntimeError("Array of size %d indexed by %d", streamNumbers_arraysize, k);
    this->streamNumbers[k] = streamNumbers;
}
...
{
    return dynamic_cast<SCTPIncomingSSNResetRequestParameter *>(obj)!=nullptr;
}
...
SCTPSSNTSNResetRequestParameter::SCTPSSNTSNResetRequestParameter(const char *name, int kind) : ::inet::sctp::SCTPParameter(name,kind)
{
    this->srReqSn = 0;
}
...
SCTPStreamResetResponseParameter::SCTPStreamResetResponseParameter(const char *name, int kind) : ::inet::sctp::SCTPParameter(name,kind)
{
    this->srResSn = 0;
    this->result = 0;
...
SCTPResetTimer::SCTPResetTimer(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->inSN = 0;
    this->inAcked = false;
    this->outSN = 0;
...
SCTPAuthenticationChunk::SCTPAuthenticationChunk(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->sharedKey = 0;
...
SCTPAsconfChunk_Base::SCTPAsconfChunk_Base(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->serialNumber = 0;
    this->peerVTag = 0;
}
...
SCTPAsconfAckChunk_Base::SCTPAsconfAckChunk_Base(const char *name, int kind) : ::inet::sctp::SCTPChunk(name,kind)
{
    this->serialNumber = 0;
}
...
SCTPAddIPParameter::SCTPAddIPParameter(const char *name, int kind) : ::inet::sctp::SCTPParameter(name,kind)
{
...
SCTPDeleteIPParameter::SCTPDeleteIPParameter(const char *name, int kind) : ::inet::sctp::SCTPParameter(name,kind)
{
    this->requestCorrelationId = 0;
}
...
SCTPSetPrimaryIPParameter::SCTPSetPrimaryIPParameter(const char *name, int kind) : ::inet::sctp::SCTPParameter(name,kind)
{
    this->requestCorrelationId = 0;
}
...
SCTPSupportedExtensionsParameter::SCTPSupportedExtensionsParameter(const char *name, int kind) : ::inet::sctp::SCTPParameter(name,kind)
{
    chunkTypes_arraysize = 0;
    this->chunkTypes = 0;
}
...
SCTPErrorCauseParameter::SCTPErrorCauseParameter(const char *name, int kind) : ::inet::sctp::SCTPParameter(name,kind)
{
...
SCTPSimpleErrorCauseParameter::SCTPSimpleErrorCauseParameter(const char *name, int kind) : ::inet::sctp::SCTPParameter(name,kind)
{
    this->value = 0;
}
...
SCTPSuccessIndication::SCTPSuccessIndication(const char *name, int kind) : ::inet::sctp::SCTPParameter(name,kind)
{
    this->responseCorrelationId = 0;
}
...
NatMessage::NatMessage(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->multi = false;
    this->peer1 = 0;
