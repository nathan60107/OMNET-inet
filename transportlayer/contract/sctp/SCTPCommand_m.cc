//
// Generated file, do not edit! Created by nedtool 5.0 from inet/transportlayer/contract/sctp/SCTPCommand.msg.
//
...
SCTPCommand::SCTPCommand(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->assocId = -1;
    this->sid = -1;
    this->numMsgs = 1;
...
const char *SCTPOpenCommandDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        ...
        case 2: return omnetpp::opp_typename(typeid(AddressVector));
        default: return nullptr;
    };
}
...
void SCTPResetInfo::copy(const SCTPResetInfo& other)
{
    ...
    delete [] this->streams;
    this->streams = (other.streams_arraysize==0) ? nullptr : new char[other.streams_arraysize];
...
void SCTPResetInfo::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    if (streams_arraysize==0) {
        ...
        this->streams = new char[streams_arraysize];
...
{
    char *streams2 = (size==0) ? nullptr : new char[size];
...
SCTPSimpleMessage::SCTPSimpleMessage(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->dataLen = 0;
    data_arraysize = 0;
    this->data = 0;
