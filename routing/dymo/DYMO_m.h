...
/**
 * Class generated from <tt>inet/routing/dymo/DYMO.msg:37</tt> by nedtool.
 * <pre>
 * class AddressBlock
 * {
 *     L3Address address;
...
/**
 * Class generated from <tt>inet/routing/dymo/DYMO.msg:54</tt> by nedtool.
 * <pre>
 * message RREQTimer
 * {
 *     L3Address target;
...
class RREQTimer : public ::omnetpp::cMessage
{
  ...
  public:
    RREQTimer(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/routing/dymo/DYMO.msg:58</tt> by nedtool.
 * <pre>
...
class RREQWaitRREPTimer : public ::inet::dymo::RREQTimer
{
  ...
  public:
    RREQWaitRREPTimer(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/routing/dymo/DYMO.msg:62</tt> by nedtool.
 * <pre>
...
class RREQBackoffTimer : public ::inet::dymo::RREQTimer
{
  ...
  public:
    RREQBackoffTimer(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/routing/dymo/DYMO.msg:66</tt> by nedtool.
 * <pre>
...
class RREQHolddownTimer : public ::inet::dymo::RREQTimer
{
  ...
  public:
    RREQHolddownTimer(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/routing/dymo/DYMO.msg:73</tt> by nedtool.
 * <pre>
 * packet DYMOPacket
 * {
 *     int hopLimit;
...
class DYMOPacket : public ::omnetpp::cPacket
{
  ...
  public:
    DYMOPacket(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/routing/dymo/DYMO.msg:77</tt> by nedtool.
 * <pre>
...
class RteMsg : public ::inet::dymo::DYMOPacket
{
  ...
  public:
    RteMsg(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/routing/dymo/DYMO.msg:87</tt> by nedtool.
 * <pre>
 * //
 * // DYMO RREQ packet
 * //
...
/**
 * Class generated from <tt>inet/routing/dymo/DYMO.msg:93</tt> by nedtool.
 * <pre>
 * //
 * // DYMO RREP packet
 * //
...
/**
 * Class generated from <tt>inet/routing/dymo/DYMO.msg:99</tt> by nedtool.
 * <pre>
 * //
...
class RREP_ACK : public ::inet::dymo::DYMOPacket
{
  ...
  public:
    RREP_ACK(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/routing/dymo/DYMO.msg:105</tt> by nedtool.
 * <pre>
 * //
 * // DYMO RERR packet
 * //
...
class RERR : public ::inet::dymo::DYMOPacket
{
  ...
  public:
    RERR(const char *name=nullptr, int kind=0);
