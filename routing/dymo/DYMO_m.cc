//
// Generated file, do not edit! Created by nedtool 5.0 from inet/routing/dymo/DYMO.msg.
//
...
RREQTimer::RREQTimer(const char *name, int kind) : ::omnetpp::cMessage(name,kind)
{
}
...
RREQWaitRREPTimer::RREQWaitRREPTimer(const char *name, int kind) : ::inet::dymo::RREQTimer(name,kind)
{
    this->retryCount = 0;
}
...
RREQBackoffTimer::RREQBackoffTimer(const char *name, int kind) : ::inet::dymo::RREQTimer(name,kind)
{
    this->retryCount = 0;
}
...
RREQHolddownTimer::RREQHolddownTimer(const char *name, int kind) : ::inet::dymo::RREQTimer(name,kind)
{
}
...
DYMOPacket::DYMOPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->hopLimit = 0;
}
...
RteMsg::RteMsg(const char *name, int kind) : ::inet::dymo::DYMOPacket(name,kind)
{
    this->hopCount = 0;
...
RREQ::RREQ(const char *name, int kind) : ::inet::dymo::RteMsg(name,kind)
{
}
...
RREP::RREP(const char *name, int kind) : ::inet::dymo::RteMsg(name,kind)
{
}
...
RREP_ACK::RREP_ACK(const char *name, int kind) : ::inet::dymo::DYMOPacket(name,kind)
{
}
...
RERR::RERR(const char *name, int kind) : ::inet::dymo::DYMOPacket(name,kind)
{
