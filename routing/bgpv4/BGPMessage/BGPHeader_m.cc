//
// Generated file, do not edit! Created by nedtool 5.0 from inet/routing/bgpv4/BGPMessage/BGPHeader.msg.
//
...
BGPHeader::BGPHeader(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->setByteLength(BGP_HEADER_OCTETS);

    this->type = 0;
}

BGPHeader::BGPHeader(const BGPHeader& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
char BGPHeader::getType() const
{
    return this->type;
}

void BGPHeader::setType(char type)
{
    this->type = type;
}
...
BGPHeaderDescriptor::BGPHeaderDescriptor() : omnetpp::cClassDescriptor("inet::bgp::BGPHeader", "omnetpp::cPacket")
{
...
std::string BGPHeaderDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    BGPHeader *pp = (BGPHeader *)object; (void)pp;
    switch (field) {
        case 0: return enum2string(pp->getType(), "inet::bgp::BGPType");
        default: return "";
    }
}
...
bool BGPHeaderDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    BGPHeader *pp = (BGPHeader *)object; (void)pp;
    switch (field) {
        case 0: pp->setType((inet::bgp::BGPType)string2enum(value, "inet::bgp::BGPType")); return true;
