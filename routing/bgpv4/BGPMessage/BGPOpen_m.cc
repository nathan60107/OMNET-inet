//
// Generated file, do not edit! Created by nedtool 5.0 from inet/routing/bgpv4/BGPMessage/BGPOpen.msg.
//
...
BGPOpenMessage::BGPOpenMessage(const char *name, int kind) : ::inet::bgp::BGPHeader(name,kind)
{
