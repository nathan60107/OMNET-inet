//
// Generated file, do not edit! Created by nedtool 5.0 from inet/routing/bgpv4/BGPMessage/BGPUpdate.msg.
//
...
BGPUpdateMessage_Base::BGPUpdateMessage_Base(const char *name, int kind) : ::inet::bgp::BGPHeader(name,kind)
{
...
{
    delete [] this->withdrawnRoutes_var;
    this->withdrawnRoutes_var = (other.withdrawnRoutes_arraysize==0) ? nullptr : new BGPUpdateWithdrawnRoutes[other.withdrawnRoutes_arraysize];
    ...
    delete [] this->pathAttributeList_var;
    this->pathAttributeList_var = (other.pathAttributeList_arraysize==0) ? nullptr : new BGPUpdatePathAttributeList[other.pathAttributeList_arraysize];
...
void BGPUpdateMessage_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimArrayPacking(b,this->withdrawnRoutes_var,withdrawnRoutes_arraysize);
    b->pack(pathAttributeList_arraysize);
    doParsimArrayPacking(b,this->pathAttributeList_var,pathAttributeList_arraysize);
    doParsimPacking(b,this->NLRI_var);
}
...
void BGPUpdateMessage_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    if (withdrawnRoutes_arraysize==0) {
        ...
        doParsimArrayUnpacking(b,this->withdrawnRoutes_var,withdrawnRoutes_arraysize);
    }
    delete [] this->pathAttributeList_var;
    ...
    if (pathAttributeList_arraysize==0) {
        ...
        doParsimArrayUnpacking(b,this->pathAttributeList_var,pathAttributeList_arraysize);
    }
    doParsimUnpacking(b,this->NLRI_var);
}

void BGPUpdateMessage_Base::setWithdrawnRoutesArraySize(unsigned int size)
{
    BGPUpdateWithdrawnRoutes *withdrawnRoutes_var2 = (size==0) ? nullptr : new BGPUpdateWithdrawnRoutes[size];
...
BGPUpdateWithdrawnRoutes& BGPUpdateMessage_Base::getWithdrawnRoutes(unsigned int k)
{
    ...
    return this->withdrawnRoutes_var[k];
}
...
{
    BGPUpdatePathAttributeList *pathAttributeList_var2 = (size==0) ? nullptr : new BGPUpdatePathAttributeList[size];
...
BGPUpdatePathAttributeList& BGPUpdateMessage_Base::getPathAttributeList(unsigned int k)
{
    ...
    return this->pathAttributeList_var[k];
}
