//
// Generated file, do not edit! Created by nedtool 5.0 from inet/routing/ospfv2/OSPFPacket.msg.
//
...
OSPFPacket::OSPFPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->version = 2;
...
OSPFHelloPacket::OSPFHelloPacket(const char *name, int kind) : ::inet::ospf::OSPFPacket(name,kind)
{
...
OSPFDatabaseDescriptionPacket::OSPFDatabaseDescriptionPacket(const char *name, int kind) : ::inet::ospf::OSPFPacket(name,kind)
{
    this->interfaceMTU = 0;
...
OSPFLinkStateRequestPacket::OSPFLinkStateRequestPacket(const char *name, int kind) : ::inet::ospf::OSPFPacket(name,kind)
{
...
OSPFLinkStateUpdatePacket::OSPFLinkStateUpdatePacket(const char *name, int kind) : ::inet::ospf::OSPFPacket(name,kind)
{
    this->numberOfLSAs = 0;
...
OSPFLinkStateAcknowledgementPacket::OSPFLinkStateAcknowledgementPacket(const char *name, int kind) : ::inet::ospf::OSPFPacket(name,kind)
{
    lsaHeaders_arraysize = 0;
    this->lsaHeaders = 0;
}
