//
// Generated file, do not edit! Created by nedtool 5.0 from inet/routing/pim/PIMPacket.msg.
//
...
PIMPacket::PIMPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->version = 2;
    this->type = 0;
}
...
std::string PIMJoinPruneDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    PIMJoinPrune *pp = (PIMJoinPrune *)object; (void)pp;
    switch (field) {
        case 0: return enum2string(pp->getType(), "inet::PIMPacketType");
...
bool PIMJoinPruneDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    PIMJoinPrune *pp = (PIMJoinPrune *)object; (void)pp;
    switch (field) {
        case 0: pp->setType((inet::PIMPacketType)string2enum(value, "inet::PIMPacketType")); return true;
...
const char *PIMJoinPruneDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        ...
        case 3: return omnetpp::opp_typename(typeid(JoinPruneGroup));
        default: return nullptr;
    };
}
...
void *PIMJoinPruneDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return (void *)static_cast<omnetpp::cObject *>(&pp->getJoinPruneGroups(i)); break;
        default: return nullptr;
    }
}
