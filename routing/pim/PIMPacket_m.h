...
class PIMPacket : public ::omnetpp::cPacket
{
  ...
  public:
    PIMPacket(const char *name=nullptr, int kind=0);
 ...
 *   public:
 *     PIMHello(const char *name=nullptr, int kind=0) : PIMHello_Base(name,kind) {}
...
class PIMHello_Base : public ::inet::PIMPacket
{
  ...
  protected:
    ...
    PIMHello_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual PIMHello_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class PIMHello");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
...
class PIMJoinPrune : public ::inet::PIMPacket
{
  ...
  public:
    PIMJoinPrune(const char *name=nullptr, int kind=0);
...
class PIMAssert : public ::inet::PIMPacket
{
  ...
  public:
    PIMAssert(const char *name=nullptr, int kind=0);
...
class PIMGraft : public ::inet::PIMJoinPrune
{
  ...
  public:
    PIMGraft(const char *name=nullptr, int kind=0);
...
class PIMGraftAck : public ::inet::PIMGraft
{
  ...
  public:
    PIMGraftAck(const char *name=nullptr, int kind=0);
...
class PIMStateRefresh : public ::inet::PIMPacket
{
  ...
  public:
    PIMStateRefresh(const char *name=nullptr, int kind=0);
...
class PIMRegister : public ::inet::PIMPacket
{
  ...
  public:
    PIMRegister(const char *name=nullptr, int kind=0);
...
class PIMRegisterStop : public ::inet::PIMPacket
{
  ...
  public:
    PIMRegisterStop(const char *name=nullptr, int kind=0);
