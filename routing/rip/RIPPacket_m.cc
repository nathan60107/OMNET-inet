//
// Generated file, do not edit! Created by nedtool 5.0 from inet/routing/rip/RIPPacket.msg.
//
...
RIPPacket::RIPPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->command = 0;
    entry_arraysize = 0;
    this->entry = 0;
