//
// Generated file, do not edit! Created by nedtool 5.0 from inet/routing/gpsr/GPSR.msg.
//
...
GPSRBeacon::GPSRBeacon(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
}
