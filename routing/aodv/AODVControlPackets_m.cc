//
// Generated file, do not edit! Created by nedtool 5.0 from inet/routing/aodv/AODVControlPackets.msg.
//
...
AODVControlPacket::AODVControlPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->packetType = 0;
}
...
WaitForRREP::WaitForRREP(const char *name, int kind) : ::omnetpp::cMessage(name,kind)
{
    this->lastTTL = 0;
