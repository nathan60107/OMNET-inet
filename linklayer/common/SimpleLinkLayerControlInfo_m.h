...
class SimpleLinkLayerControlInfo_Base : public ::omnetpp::cObject
{
  ...
  public:
    ...
    virtual SimpleLinkLayerControlInfo_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class SimpleLinkLayerControlInfo");}
