//
// Generated file, do not edit! Created by nedtool 5.0 from inet/linklayer/ieee8021d/common/Ieee8021dBPDU.msg.
//
...
BPDU::BPDU(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
