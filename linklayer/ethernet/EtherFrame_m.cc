//
// Generated file, do not edit! Created by nedtool 5.0 from inet/linklayer/ethernet/EtherFrame.msg.
//
...
EtherTraffic::EtherTraffic(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
}
...
EtherFilledIFG::EtherFilledIFG(const char *name, int kind) : ::inet::EtherTraffic(name,kind)
{
...
EtherPhyFrame_Base::EtherPhyFrame_Base(const char *name, int kind) : ::inet::EtherTraffic(name,kind)
{
...
EtherFrame::EtherFrame(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
}
...
Ethernet1QTag::Ethernet1QTag(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->pcp = 0;
    this->de = false;
    this->VID = 0;
...
Ethernet1ahITag::Ethernet1ahITag(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->ISid = 0;
}
