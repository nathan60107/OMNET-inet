 ...
 * </pre>
 */
class EtherTraffic : public ::omnetpp::cPacket
{
  protected:
  ...
  public:
    EtherTraffic(const char *name=nullptr, int kind=0);
...
class EtherJam : public ::inet::EtherTraffic
{
  ...
  public:
    EtherJam(const char *name=nullptr, int kind=0);
 ...
 * </pre>
 */
class EtherFilledIFG : public ::inet::EtherTraffic
{
  protected:
 ...
 *     virtual EtherPhyFrame *dup() const {return new EtherPhyFrame(*this);}
 ...
 * </pre>
 */
class EtherPhyFrame_Base : public ::inet::EtherTraffic
{
  protected:
  ...
  protected:
    ...
    EtherPhyFrame_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual EtherPhyFrame_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class EtherPhyFrame");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
...
class EtherFrame : public ::omnetpp::cPacket
{
  ...
  public:
    EtherFrame(const char *name=nullptr, int kind=0);
...
class EthernetIIFrame : public ::inet::EtherFrame
{
  ...
  public:
    EthernetIIFrame(const char *name=nullptr, int kind=0);
...
class EtherFrameWithLLC : public ::inet::EtherFrame
{
  ...
  public:
    EtherFrameWithLLC(const char *name=nullptr, int kind=0);
...
class EtherFrameWithSNAP : public ::inet::EtherFrameWithLLC
{
  ...
  public:
    EtherFrameWithSNAP(const char *name=nullptr, int kind=0);
...
class EtherPauseFrame : public ::inet::EtherFrame
{
  ...
  public:
    EtherPauseFrame(const char *name=nullptr, int kind=0);
 ...
 * </pre>
 */
class Ethernet1QTag : public ::omnetpp::cPacket
{
  protected:
    uint8_t pcp;
    bool de;
  ...
  public:
    Ethernet1QTag(const char *name=nullptr, int kind=0);
 ...
 * </pre>
 */
class Ethernet1ahITag : public ::omnetpp::cPacket
{
  protected:
    int ISid;
  ...
  public:
    Ethernet1ahITag(const char *name=nullptr, int kind=0);
