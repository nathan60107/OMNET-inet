//
// Generated file, do not edit! Created by nedtool 5.0 from inet/linklayer/ieee80211/mgmt/Ieee80211MgmtFrames.msg.
//
...
const char *Ieee80211ActionFrameDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 0: return omnetpp::opp_typename(typeid(Ieee80211ActionFrameBody));
        default: return nullptr;
    };
}
