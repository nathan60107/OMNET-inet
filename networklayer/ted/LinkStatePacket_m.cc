//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/ted/LinkStatePacket.msg.
//
...
LinkStateMsg::LinkStateMsg(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
