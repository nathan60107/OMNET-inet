...
/**
 * Class generated from <tt>inet/networklayer/flood/FloodDatagram.msg:27</tt> by nedtool.
 * <pre>
...
class FloodDatagram_Base : public ::inet::NetworkDatagramBase
{
  ...
  protected:
    ...
    FloodDatagram_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual FloodDatagram_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class FloodDatagram");}
