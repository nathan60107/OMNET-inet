...
/**
 * Class generated from <tt>inet/networklayer/common/SimpleNetworkProtocolControlInfo.msg:31</tt> by nedtool.
 * <pre>
 * //
...
class SimpleNetworkProtocolControlInfo_Base : public ::omnetpp::cObject
{
  ...
  public:
    ...
    virtual SimpleNetworkProtocolControlInfo_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class SimpleNetworkProtocolControlInfo");}
