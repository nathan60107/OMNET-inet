//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/common/EchoPacket.msg.
//
...
EXECUTE_ON_STARTUP(
    omnetpp::cEnum *e = omnetpp::cEnum::find("inet::EchoProtocolType");
    if (!e) omnetpp::enums.getInstance()->add(e = new omnetpp::cEnum("inet::EchoProtocolType"));
...
EchoPacket::EchoPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->type = 0;
}

EchoPacket::EchoPacket(const EchoPacket& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
EchoPacketDescriptor::EchoPacketDescriptor() : omnetpp::cClassDescriptor("inet::EchoPacket", "omnetpp::cPacket")
{
...
int EchoPacketDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string EchoPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    EchoPacket *pp = (EchoPacket *)object; (void)pp;
    switch (field) {
        case 0: return enum2string(pp->getType(), "inet::EchoProtocolType");
        default: return "";
    }
}

bool EchoPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    EchoPacket *pp = (EchoPacket *)object; (void)pp;
    switch (field) {
        case 0: pp->setType((inet::EchoProtocolType)string2enum(value, "inet::EchoProtocolType")); return true;
...
void *EchoPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
