//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/common/IPProtocolId.msg.
//
...
IPRegisterProtocolCommand::IPRegisterProtocolCommand() : ::omnetpp::cObject()
{
    this->protocol = 0;
}

IPRegisterProtocolCommand::IPRegisterProtocolCommand(const IPRegisterProtocolCommand& other) : ::omnetpp::cObject(other)
{
    copy(other);
}
...
void IPRegisterProtocolCommand::parsimPack(omnetpp::cCommBuffer *b) const
{
    doParsimPacking(b,this->protocol);
}

void IPRegisterProtocolCommand::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
class IPRegisterProtocolCommandDescriptor : public omnetpp::cClassDescriptor
{
  private:
...
IPRegisterProtocolCommandDescriptor::IPRegisterProtocolCommandDescriptor() : omnetpp::cClassDescriptor("inet::IPRegisterProtocolCommand", "omnetpp::cObject")
{
...
bool IPRegisterProtocolCommandDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<IPRegisterProtocolCommand *>(obj)!=nullptr;
}

const char **IPRegisterProtocolCommandDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
int IPRegisterProtocolCommandDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 1+basedesc->getFieldCount() : 1;
}

unsigned int IPRegisterProtocolCommandDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *IPRegisterProtocolCommandDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int IPRegisterProtocolCommandDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *IPRegisterProtocolCommandDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **IPRegisterProtocolCommandDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *IPRegisterProtocolCommandDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int IPRegisterProtocolCommandDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string IPRegisterProtocolCommandDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool IPRegisterProtocolCommandDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *IPRegisterProtocolCommandDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *IPRegisterProtocolCommandDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
