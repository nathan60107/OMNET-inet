//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/arp/ipv4/ARPPacket.msg.
//
...
ARPPacket::ARPPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->opcode = 0;
}
