...
class WiseRouteDatagram_Base : public ::inet::NetworkDatagramBase
{
  ...
  protected:
    ...
    WiseRouteDatagram_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual WiseRouteDatagram_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class WiseRouteDatagram");}
