//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/xmipv6/MobilityHeader.msg.
//
...
MobilityHeader::MobilityHeader(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
