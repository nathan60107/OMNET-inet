...
class MobilityHeader : public ::omnetpp::cPacket
{
  ...
  public:
    MobilityHeader(const char *name=nullptr, int kind=0);
...
class BindingUpdate : public ::inet::MobilityHeader
{
  ...
  public:
    BindingUpdate(const char *name=nullptr, int kind=0);
...
class BindingAcknowledgement : public ::inet::MobilityHeader
{
  ...
  public:
    BindingAcknowledgement(const char *name=nullptr, int kind=0);
...
class BindingError : public ::inet::MobilityHeader
{
  ...
  public:
    BindingError(const char *name=nullptr, int kind=0);
...
class HomeTestInit : public ::inet::MobilityHeader
{
  ...
  public:
    HomeTestInit(const char *name=nullptr, int kind=0);
...
class HomeTest : public ::inet::MobilityHeader
{
  ...
  public:
    HomeTest(const char *name=nullptr, int kind=0);
...
class CareOfTestInit : public ::inet::MobilityHeader
{
  ...
  public:
    CareOfTestInit(const char *name=nullptr, int kind=0);
...
class CareOfTest : public ::inet::MobilityHeader
{
  ...
  public:
    CareOfTest(const char *name=nullptr, int kind=0);
...
class BindingRefreshRequest : public ::inet::MobilityHeader
{
  ...
  public:
    BindingRefreshRequest(const char *name=nullptr, int kind=0);
...
class HomeAddressOption_Base : public ::inet::IPv6DestinationOptionsHeader
{
  ...
  public:
    ...
    virtual HomeAddressOption_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class HomeAddressOption");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
