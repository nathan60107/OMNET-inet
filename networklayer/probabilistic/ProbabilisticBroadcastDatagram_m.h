...
class ProbabilisticBroadcastDatagram_Base : public ::inet::NetworkDatagramBase
{
  ...
  protected:
    ...
    ProbabilisticBroadcastDatagram_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual ProbabilisticBroadcastDatagram_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class ProbabilisticBroadcastDatagram");}
