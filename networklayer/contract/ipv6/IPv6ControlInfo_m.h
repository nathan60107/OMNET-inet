...
/**
 * Class generated from <tt>inet/networklayer/contract/ipv6/IPv6ControlInfo.msg:68</tt> by nedtool.
 * <pre>
 * //
...
class IPv6ControlInfo_Base : public ::omnetpp::cObject
{
  ...
  public:
    ...
    virtual IPv6ControlInfo_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class IPv6ControlInfo");}
