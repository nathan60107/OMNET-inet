//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/contract/ipv6/IPv6ControlInfo.msg.
//
...
void IPv6ControlInfo_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->trafficClass_var);
    ...
    doParsimPacking(b,this->hopLimit_var);
...
void IPv6ControlInfo_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->trafficClass_var);
    ...
    doParsimUnpacking(b,this->hopLimit_var);
