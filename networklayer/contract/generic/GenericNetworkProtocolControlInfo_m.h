...
class GenericNetworkProtocolControlInfo_Base : public ::omnetpp::cObject
{
  ...
  public:
    ...
    virtual GenericNetworkProtocolControlInfo_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class GenericNetworkProtocolControlInfo");}
