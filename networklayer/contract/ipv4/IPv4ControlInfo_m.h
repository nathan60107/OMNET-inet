...
/**
 * Class generated from <tt>inet/networklayer/contract/ipv4/IPv4ControlInfo.msg:63</tt> by nedtool.
 * <pre>
 * //
...
class IPv4ControlInfo_Base : public ::omnetpp::cObject
{
  ...
  public:
    ...
    virtual IPv4ControlInfo_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class IPv4ControlInfo");}
