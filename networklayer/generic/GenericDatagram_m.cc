//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/generic/GenericDatagram.msg.
//
...
GenericDatagram_Base::GenericDatagram_Base(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
