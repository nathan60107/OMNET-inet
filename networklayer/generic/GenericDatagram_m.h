...
/**
 * Enum generated from <tt>inet/networklayer/generic/GenericDatagram.msg:35</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>inet/networklayer/generic/GenericDatagram.msg:47</tt> by nedtool.
 * <pre>
 * //
...
class GenericDatagram_Base : public ::omnetpp::cPacket
{
  ...
  protected:
    ...
    GenericDatagram_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual GenericDatagram_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class GenericDatagram");}
