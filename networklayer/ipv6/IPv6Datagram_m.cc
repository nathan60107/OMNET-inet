//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/ipv6/IPv6Datagram.msg.
//
...
IPv6Datagram_Base::IPv6Datagram_Base(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->trafficClass = 0;
    this->flowLabel = 0;
    this->hopLimit = 0;
