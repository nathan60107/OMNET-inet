 ...
 * </pre>
 */
class IPv6Datagram_Base : public ::omnetpp::cPacket
{
  protected:
    IPv6Address srcAddress;
    IPv6Address destAddress;
  ...
  protected:
    ...
    IPv6Datagram_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual IPv6Datagram_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class IPv6Datagram");}
 ...
 * </pre>
 */
class IPv6ExtensionHeader : public ::omnetpp::cObject
{
  protected:
    short extensionType;
    short byteLength;
