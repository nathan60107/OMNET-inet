 ...
 * </pre>
 */
class IPv6HopByHopOptionsHeader : public ::inet::IPv6ExtensionHeader
{
  protected:
    TLVOptions tlvOptions;
 ...
 * </pre>
 */
class IPv6RoutingHeader_Base : public ::inet::IPv6ExtensionHeader
{
  protected:
    uint8_t routingType;
  ...
  public:
    ...
    virtual IPv6RoutingHeader_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class IPv6RoutingHeader");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
 ...
 * </pre>
 */
class IPv6FragmentHeader : public ::inet::IPv6ExtensionHeader
{
  protected:
    unsigned short fragmentOffset;
 ...
 * </pre>
 */
class IPv6DestinationOptionsHeader : public ::inet::IPv6ExtensionHeader
{
  protected:
    TLVOptions tlvOptions;
 ...
 * </pre>
 */
class IPv6AuthenticationHeader : public ::inet::IPv6ExtensionHeader
{
  protected:
 ...
 * </pre>
 */
class IPv6EncapsulatingSecurityPayloadHeader : public ::inet::IPv6ExtensionHeader
{
  protected:
