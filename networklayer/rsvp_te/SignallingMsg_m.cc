//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/rsvp_te/SignallingMsg.msg.
//
...
SignallingMsg::SignallingMsg(const char *name, int kind) : ::omnetpp::cMessage(name,kind)
{
    this->command = 0;
}
...
SignallingMsgDescriptor::SignallingMsgDescriptor() : omnetpp::cClassDescriptor("inet::SignallingMsg", "omnetpp::cMessage")
{
...
PsbTimerMsgDescriptor::PsbTimerMsgDescriptor() : omnetpp::cClassDescriptor("inet::PsbTimerMsg", "inet::SignallingMsg")
{
    propertynames = nullptr;
}
...
PsbTimeoutMsgDescriptor::PsbTimeoutMsgDescriptor() : omnetpp::cClassDescriptor("inet::PsbTimeoutMsg", "inet::SignallingMsg")
{
    propertynames = nullptr;
}
...
{
    this->id = 0;
    this->command = MSG_RSB_REFRESH_TIMER;
}
...
RsbRefreshTimerMsgDescriptor::RsbRefreshTimerMsgDescriptor() : omnetpp::cClassDescriptor("inet::RsbRefreshTimerMsg", "inet::SignallingMsg")
{
    propertynames = nullptr;
}
...
{
    this->id = 0;
    this->command = MSG_RSB_COMMIT_TIMER;
}
...
RsbCommitTimerMsgDescriptor::RsbCommitTimerMsgDescriptor() : omnetpp::cClassDescriptor("inet::RsbCommitTimerMsg", "inet::SignallingMsg")
{
    propertynames = nullptr;
}
...
RsbTimeoutMsgDescriptor::RsbTimeoutMsgDescriptor() : omnetpp::cClassDescriptor("inet::RsbTimeoutMsg", "inet::SignallingMsg")
{
    propertynames = nullptr;
}
...
HelloTimerMsgDescriptor::HelloTimerMsgDescriptor() : omnetpp::cClassDescriptor("inet::HelloTimerMsg", "inet::SignallingMsg")
{
    propertynames = nullptr;
}
...
{
    this->command = MSG_HELLO_TIMEOUT;
}
...
HelloTimeoutMsgDescriptor::HelloTimeoutMsgDescriptor() : omnetpp::cClassDescriptor("inet::HelloTimeoutMsg", "inet::SignallingMsg")
{
    propertynames = nullptr;
}
...
PathNotifyMsgDescriptor::PathNotifyMsgDescriptor() : omnetpp::cClassDescriptor("inet::PathNotifyMsg", "inet::SignallingMsg")
{
    propertynames = nullptr;
}
...
const char *PathNotifyMsgDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 0: return omnetpp::opp_typename(typeid(SessionObj_t));
