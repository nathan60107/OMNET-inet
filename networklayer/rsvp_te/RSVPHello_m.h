...
/**
 * Class generated from <tt>inet/networklayer/rsvp_te/RSVPHello.msg:30</tt> by nedtool.
 * <pre>
 * //
 ...
 *   public:
 *     RSVPHelloMsg(const char *name=nullptr, int kind=0) : RSVPHelloMsg_Base(name,kind) {}
...
class RSVPHelloMsg_Base : public ::inet::RSVPMessage
{
  ...
  protected:
    ...
    RSVPHelloMsg_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RSVPHelloMsg_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RSVPHelloMsg");}
