...
/**
 * Class generated from <tt>inet/networklayer/rsvp_te/RSVPPathMsg.msg:44</tt> by nedtool.
 * <pre>
 * //
 ...
 *   public:
 *     RSVPPathMsg(const char *name=nullptr, int kind=0) : RSVPPathMsg_Base(name,kind) {}
...
class RSVPPathMsg_Base : public ::inet::RSVPPacket
{
  ...
  protected:
    ...
    RSVPPathMsg_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RSVPPathMsg_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RSVPPathMsg");}
...
/**
 * Class generated from <tt>inet/networklayer/rsvp_te/RSVPPathMsg.msg:59</tt> by nedtool.
 * <pre>
 * //
 * // FIXME missing documentation
 * //
 ...
 *   public:
 *     RSVPPathTear(const char *name=nullptr, int kind=0) : RSVPPathTear_Base(name,kind) {}
...
class RSVPPathTear_Base : public ::inet::RSVPPacket
{
  ...
  protected:
    ...
    // make constructors protected to avoid instantiation
    RSVPPathTear_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RSVPPathTear_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RSVPPathTear");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
...
/**
 * Class generated from <tt>inet/networklayer/rsvp_te/RSVPPathMsg.msg:72</tt> by nedtool.
 * <pre>
 * //
 * // FIXME missing documentation
 * //
 ...
 *   public:
 *     RSVPPathError(const char *name=nullptr, int kind=0) : RSVPPathError_Base(name,kind) {}
...
class RSVPPathError_Base : public ::inet::RSVPPacket
{
  ...
  protected:
    ...
    // make constructors protected to avoid instantiation
    RSVPPathError_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RSVPPathError_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RSVPPathError");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
