...
/**
 * Class generated from <tt>inet/networklayer/rsvp_te/RSVPResvMsg.msg:38</tt> by nedtool.
 * <pre>
 * //
 ...
 *   public:
 *     RSVPResvMsg(const char *name=nullptr, int kind=0) : RSVPResvMsg_Base(name,kind) {}
...
class RSVPResvMsg_Base : public ::inet::RSVPPacket
{
  ...
  protected:
    ...
    RSVPResvMsg_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RSVPResvMsg_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RSVPResvMsg");}
...
/**
 * Class generated from <tt>inet/networklayer/rsvp_te/RSVPResvMsg.msg:49</tt> by nedtool.
 * <pre>
 * //
 * // FIXME missing documentation
 * //
 ...
 *   public:
 *     RSVPResvTear(const char *name=nullptr, int kind=0) : RSVPResvTear_Base(name,kind) {}
...
class RSVPResvTear_Base : public ::inet::RSVPPacket
{
  ...
  protected:
    ...
    // make constructors protected to avoid instantiation
    RSVPResvTear_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RSVPResvTear_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RSVPResvTear");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
...
/**
 * Class generated from <tt>inet/networklayer/rsvp_te/RSVPResvMsg.msg:60</tt> by nedtool.
 * <pre>
 * //
 * // FIXME missing documentation
 * //
 ...
 *   public:
 *     RSVPResvError(const char *name=nullptr, int kind=0) : RSVPResvError_Base(name,kind) {}
...
class RSVPResvError_Base : public ::inet::RSVPPacket
{
  ...
  protected:
    ...
    // make constructors protected to avoid instantiation
    RSVPResvError_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual RSVPResvError_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RSVPResvError");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
