...
RSVPMessage::RSVPMessage(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->rsvpKind_var = 0;
}

RSVPMessage::RSVPMessage(const RSVPMessage& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
void RSVPMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->rsvpKind_var);
}

void RSVPMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->rsvpKind_var);
}

int RSVPMessage::getRsvpKind() const
{
    return this->rsvpKind_var;
}
...
RSVPMessageDescriptor::RSVPMessageDescriptor() : omnetpp::cClassDescriptor("inet::RSVPMessage", "omnetpp::cPacket")
{
...
int RSVPMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string RSVPMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool RSVPMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *RSVPMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void RSVPPacket_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
...
void RSVPPacket_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
RSVPPacketDescriptor::RSVPPacketDescriptor() : omnetpp::cClassDescriptor("inet::RSVPPacket", "inet::RSVPMessage")
{
    propertynames = nullptr;
}
...
{
    return dynamic_cast<RSVPPacket_Base *>(obj)!=nullptr;
}
...
int RSVPPacketDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string RSVPPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool RSVPPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *RSVPPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
