//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/icmpv6/ICMPv6Message.msg.
//
...
ICMPv6Message::ICMPv6Message(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->type = 0;
}
