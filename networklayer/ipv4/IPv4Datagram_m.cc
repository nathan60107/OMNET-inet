//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/ipv4/IPv4Datagram.msg.
//
...
IPv4Datagram_Base::IPv4Datagram_Base(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->version_var = 4;
...
void IPv4Datagram_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->srcAddress_var);
    doParsimPacking(b,this->destAddress_var);
    doParsimPacking(b,this->transportProtocol_var);
    doParsimPacking(b,this->timeToLive_var);
    doParsimPacking(b,this->identification_var);
    doParsimPacking(b,this->moreFragments_var);
    doParsimPacking(b,this->dontFragment_var);
    doParsimPacking(b,this->fragmentOffset_var);
    ...
    doParsimPacking(b,this->options_var);
}
...
void IPv4Datagram_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->srcAddress_var);
    doParsimUnpacking(b,this->destAddress_var);
    doParsimUnpacking(b,this->transportProtocol_var);
    doParsimUnpacking(b,this->timeToLive_var);
    doParsimUnpacking(b,this->identification_var);
    doParsimUnpacking(b,this->moreFragments_var);
    doParsimUnpacking(b,this->dontFragment_var);
    doParsimUnpacking(b,this->fragmentOffset_var);
    ...
    doParsimUnpacking(b,this->options_var);
}
...
{
    return this->transportProtocol_var;
}
...
{
    return this->identification_var;
}
...
{
    return this->fragmentOffset_var;
}
