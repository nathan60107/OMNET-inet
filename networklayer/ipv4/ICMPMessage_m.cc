//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/ipv4/ICMPMessage.msg.
//
...
ICMPMessage::ICMPMessage(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->type = 0;
    this->code = 0;
}
