//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/ipv4/IGMPMessage.msg.
//
...
IGMPMessage::IGMPMessage(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->type = 0;
}
...
{
    ::inet::IGMPQuery::parsimPack(b);
    doParsimPacking(b,this->maxRespTime_var);
}

void IGMPv2Query::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::IGMPQuery::parsimUnpack(b);
    doParsimUnpacking(b,this->maxRespTime_var);
}

unsigned char IGMPv2Query::getMaxRespTime() const
{
    return this->maxRespTime_var;
}
...
{
    this->suppressRouterProc_var = false;
...
void IGMPv3Query_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->suppressRouterProc_var);
    doParsimPacking(b,this->robustnessVariable_var);
    doParsimPacking(b,this->queryIntervalCode_var);
    doParsimPacking(b,this->sourceList_var);
...
void IGMPv3Query_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->suppressRouterProc_var);
    doParsimUnpacking(b,this->robustnessVariable_var);
    doParsimUnpacking(b,this->queryIntervalCode_var);
    doParsimUnpacking(b,this->sourceList_var);
    // field maxRespCode is abstract -- please do unpacking in customized class
}

bool IGMPv3Query_Base::getSuppressRouterProc() const
{
    return this->suppressRouterProc_var;
}
...
{
    return this->robustnessVariable_var;
}
...
{
    return this->queryIntervalCode_var;
}
