...
class IPv4Datagram_Base : public ::omnetpp::cPacket
{
  ...
  protected:
    ...
    IPv4Datagram_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual IPv4Datagram_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class IPv4Datagram");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
