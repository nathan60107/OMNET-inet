...
/**
 * Enum generated from <tt>inet/networklayer/ipv4/IGMPMessage.msg:35</tt> by nedtool.
 * <pre>
 * enum IGMPType
 * {
 * 
...
/**
 * Class generated from <tt>inet/networklayer/ipv4/IGMPMessage.msg:44</tt> by nedtool.
 * <pre>
 * packet IGMPMessage
 * {
...
class IGMPMessage : public ::omnetpp::cPacket
{
  ...
  public:
    IGMPMessage(const char *name=nullptr, int kind=0);
...
class IGMPQuery : public ::inet::IGMPMessage
{
  ...
  public:
    IGMPQuery(const char *name=nullptr, int kind=0);
...
class IGMPv1Query : public ::inet::IGMPQuery
{
  ...
  public:
    IGMPv1Query(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/networklayer/ipv4/IGMPMessage.msg:59</tt> by nedtool.
 * <pre>
...
class IGMPv1Report : public ::inet::IGMPMessage
{
  ...
  public:
    IGMPv1Report(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/networklayer/ipv4/IGMPMessage.msg:65</tt> by nedtool.
 * <pre>
...
class IGMPv2Query : public ::inet::IGMPQuery
{
  ...
  public:
    IGMPv2Query(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/networklayer/ipv4/IGMPMessage.msg:72</tt> by nedtool.
 * <pre>
...
class IGMPv2Report : public ::inet::IGMPMessage
{
  ...
  public:
    IGMPv2Report(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/networklayer/ipv4/IGMPMessage.msg:78</tt> by nedtool.
 * <pre>
...
class IGMPv2Leave : public ::inet::IGMPMessage
{
  ...
  public:
    IGMPv2Leave(const char *name=nullptr, int kind=0);
...
/**
 * Class generated from <tt>inet/networklayer/ipv4/IGMPMessage.msg:91</tt> by nedtool.
 * <pre>
 * //
 ...
 *   public:
 *     IGMPv3Query(const char *name=nullptr, int kind=0) : IGMPv3Query_Base(name,kind) {}
...
class IGMPv3Query_Base : public ::inet::IGMPv2Query
{
  ...
  protected:
    ...
    IGMPv3Query_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual IGMPv3Query_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class IGMPv3Query");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);
...
/**
 * Enum generated from <tt>inet/networklayer/ipv4/IGMPMessage.msg:102</tt> by nedtool.
 * <pre>
...
/**
 * Struct generated from inet/networklayer/ipv4/IGMPMessage.msg:112 by nedtool.
 */
struct GroupRecord
{
    GroupRecord();
...
/**
 * Class generated from <tt>inet/networklayer/ipv4/IGMPMessage.msg:119</tt> by nedtool.
 * <pre>
...
class IGMPv3Report : public ::inet::IGMPMessage
{
  ...
  public:
    IGMPv3Report(const char *name=nullptr, int kind=0);
