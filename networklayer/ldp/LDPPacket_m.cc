//
// Generated file, do not edit! Created by nedtool 5.0 from inet/networklayer/ldp/LDPPacket.msg.
//
...
LDPPacket::LDPPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->type = 0;
}
