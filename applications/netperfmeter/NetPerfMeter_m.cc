...
NetPerfMeterTransmitTimer::NetPerfMeterTransmitTimer(const char *name, int kind) : ::omnetpp::cMessage(name,kind)
{
    this->streamID = 0;
}
...
NetPerfMeterTransmitTimerDescriptor::NetPerfMeterTransmitTimerDescriptor() : omnetpp::cClassDescriptor("inet::NetPerfMeterTransmitTimer", "omnetpp::cMessage")
{
...
int NetPerfMeterTransmitTimerDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string NetPerfMeterTransmitTimerDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool NetPerfMeterTransmitTimerDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *NetPerfMeterTransmitTimerDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
{
    doParsimPacking(b,(::inet::SCTPSimpleMessage&)*this);
}

void NetPerfMeterDataMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    doParsimUnpacking(b,(::inet::SCTPSimpleMessage&)*this);
}
...
NetPerfMeterDataMessageDescriptor::NetPerfMeterDataMessageDescriptor() : omnetpp::cClassDescriptor("inet::NetPerfMeterDataMessage", "inet::SCTPSimpleMessage")
{
    propertynames = nullptr;
}
...
int NetPerfMeterDataMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string NetPerfMeterDataMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool NetPerfMeterDataMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *NetPerfMeterDataMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
