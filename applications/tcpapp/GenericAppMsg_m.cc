//
// Generated file, do not edit! Created by nedtool 5.0 from inet/applications/tcpapp/GenericAppMsg.msg.
//
...
GenericAppMsg::GenericAppMsg(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
...
GenericAppMsg::GenericAppMsg(const GenericAppMsg& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
GenericAppMsgDescriptor::GenericAppMsgDescriptor() : omnetpp::cClassDescriptor("inet::GenericAppMsg", "omnetpp::cPacket")
{
