//
// Generated file, do not edit! Created by nedtool 5.0 from inet/applications/pingapp/PingPayload.msg.
//
...
PingPayload::PingPayload(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->originatorId = 0;
    this->seqNo = 0;
    data_arraysize = 0;
