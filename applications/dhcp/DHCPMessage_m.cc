//
// Generated file, do not edit! Created by nedtool 5.0 from inet/applications/dhcp/DHCPMessage.msg.
//
...
DHCPMessage::DHCPMessage(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->op = 0;
    this->htype = 0;
    this->hlen = 0;
