//
// Generated file, do not edit! Created by nedtool 5.0 from inet/applications/httptools/common/HttpMessages.msg.
//
...
HttpBaseMessage::HttpBaseMessage(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
...
HttpRequestMessage::HttpRequestMessage(const char *name, int kind) : ::inet::httptools::HttpBaseMessage(name,kind)
{
...
HttpReplyMessage::HttpReplyMessage(const char *name, int kind) : ::inet::httptools::HttpBaseMessage(name,kind)
{
    this->result_var = 0;
