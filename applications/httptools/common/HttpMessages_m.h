...
class HttpBaseMessage : public ::omnetpp::cPacket
{
  ...
  public:
    HttpBaseMessage(const char *name=nullptr, int kind=0);
...
class HttpRequestMessage : public ::inet::httptools::HttpBaseMessage
{
  ...
  public:
    HttpRequestMessage(const char *name=nullptr, int kind=0);
...
class HttpReplyMessage : public ::inet::httptools::HttpBaseMessage
{
  ...
  public:
    HttpReplyMessage(const char *name=nullptr, int kind=0);
