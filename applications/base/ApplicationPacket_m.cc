//
// Generated file, do not edit! Created by nedtool 5.0 from inet/applications/base/ApplicationPacket.msg.
//
...
ApplicationPacket::ApplicationPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
...
long ApplicationPacket::getSequenceNumber() const
{
    return this->sequenceNumber;
}

void ApplicationPacket::setSequenceNumber(long sequenceNumber)
{
...
ApplicationPacketDescriptor::ApplicationPacketDescriptor() : omnetpp::cClassDescriptor("inet::ApplicationPacket", "omnetpp::cPacket")
{
