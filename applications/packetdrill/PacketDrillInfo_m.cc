//
// Generated file, do not edit! Created by nedtool 5.0 from inet/applications/packetdrill/PacketDrillInfo.msg.
//
...
PacketDrillInfo::PacketDrillInfo(const char *name, int kind) : ::omnetpp::cMessage(name,kind)
{
    this->scriptTime = 0;
    this->scriptTimeEnd = 0;
    this->offset = 0;
    this->timeType = 0;
    this->liveTime = 0;
}
...
PacketDrillInfoDescriptor::PacketDrillInfoDescriptor() : omnetpp::cClassDescriptor("PacketDrillInfo", "omnetpp::cMessage")
{
...
std::string PacketDrillInfoDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    PacketDrillInfo *pp = (PacketDrillInfo *)object; (void)pp;
    switch (field) {
        case 0: return simtime2string(pp->getScriptTime());
        case 1: return simtime2string(pp->getScriptTimeEnd());
        case 2: return simtime2string(pp->getOffset());
        case 3: return ulong2string(pp->getTimeType());
        case 4: return simtime2string(pp->getLiveTime());
        default: return "";
    }
}
...
bool PacketDrillInfoDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    PacketDrillInfo *pp = (PacketDrillInfo *)object; (void)pp;
    switch (field) {
        case 0: pp->setScriptTime(string2simtime(value)); return true;
        case 1: pp->setScriptTimeEnd(string2simtime(value)); return true;
        case 2: pp->setOffset(string2simtime(value)); return true;
        case 3: pp->setTimeType(string2ulong(value)); return true;
        case 4: pp->setLiveTime(string2simtime(value)); return true;
