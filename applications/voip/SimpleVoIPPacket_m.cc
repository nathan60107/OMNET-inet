//
// Generated file, do not edit! Created by nedtool 5.0 from inet/applications/voip/SimpleVoIPPacket.msg.
//
...
SimpleVoIPPacket::SimpleVoIPPacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->talkspurtID = 0;
