//
// Generated file, do not edit! Created by nedtool 5.0 from inet/applications/ethernet/EtherApp.msg.
//
...
EtherAppReq::EtherAppReq(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->requestId = 0;
    this->responseBytes = 0;
}

EtherAppReq::EtherAppReq(const EtherAppReq& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
EtherAppReqDescriptor::EtherAppReqDescriptor() : omnetpp::cClassDescriptor("inet::EtherAppReq", "omnetpp::cPacket")
{
...
int EtherAppReqDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string EtherAppReqDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool EtherAppReqDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *EtherAppReqDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
EtherAppResp::EtherAppResp(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->requestId = 0;
    this->numFrames = 0;
}

EtherAppResp::EtherAppResp(const EtherAppResp& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
EtherAppRespDescriptor::EtherAppRespDescriptor() : omnetpp::cClassDescriptor("inet::EtherAppResp", "omnetpp::cPacket")
{
    propertynames = nullptr;
}
...
int EtherAppRespDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string EtherAppRespDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool EtherAppRespDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *EtherAppRespDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
